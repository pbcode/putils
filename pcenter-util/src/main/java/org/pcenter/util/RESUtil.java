...
public class RESUtil {
	...
	public static void main(String[] args) {
		String uk = RESUtil.getUk();
		String pk = RESUtil.getPk();
...
//		RESUtil.decodeFile(file,pk);
		 ...
		 String msg_password = RESUtil.encode("helloworld",uk);
		 System.out.println("加密后数据为："+msg_password);
		 System.out.println("解密后数据为："+RESUtil.decode(msg_password,pk));
	}
}
